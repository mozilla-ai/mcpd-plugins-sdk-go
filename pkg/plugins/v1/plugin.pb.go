...
const file_plugin_proto_rawDesc = "" +
	"\n" +
	"\fplugin.proto\x12\x17mozilla.mcpd.plugins.v1\x1a\x1bgoogle/protobuf/empty.proto\"\x9a\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x0eHandleResponse\x12%.mozilla.mcpd.plugins.v1.HTTPResponse\x1a%.mozilla.mcpd.plugins.v1.HTTPResponseBdZFgithub.com/mozilla-ai/mcpd-plugins-sdk-go/pkg/plugins/v1;mcpdpluginsv1\xaa\x02\x19MozillaAI.Mcpd.Plugins.V1b\x06proto3"
